...
#below are the texts for the polls application
...
def create_question(question_text, days):
    """
    Create a question with the given 'question_text' and publiched the given
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        """
        if no questions exits, an appropriate message should be be displayed.
        :return:
        """
